...
public class DialogSearchTankFilter extends RelativeLayout implements Selectable<Entry>, View.OnClickListener, SelectionListener<Entry>, Populatable<TankFilterList>{
	...
	private TankFilterList mData;
	
	public DialogSearchTankFilter(Context context){
		this(context,null);
	}
	
	public DialogSearchTankFilter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView();
	}
	...
	private void setData(TankFilterList datas){
	...
	@Override
	public void populate(TankFilterList data) {
		// TODO Auto-generated method stub
		if(data != null){
			mData = data;
			setData(mData);
