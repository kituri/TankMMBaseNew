...
public class LAppLive2DManager
{
	...
	private Live2DOnExitListener mExitListener;


	public LAppLive2DManager(String modelPath)
	{
	...
	public void update(GL10 gl)
	{
		...
		if(reloadFlg)
		{
			...
			try {
				...
				models.get(0).load(gl, modelPath);
				models.get(0).feedIn();
			} catch (Exception e) {
	 ...
	 * @return
	 */
	public LAppView  createView(Activity act, Live2DOnExitListener exitListener)
	{
		// Viewの初期化
	...
	public interface Live2DOnExitListener{
		public void exit();
	};
