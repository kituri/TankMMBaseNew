...
public class EquipDataBase extends Entry {
	...
	public interface TYPE {
		 ...
		 * 外身
		 */
		public static final int OUTSIDE_BODY = 2;
		/**
		 * 内舱
		 */
		public static final int INTERNAL_CABINS = 3;
		/**
		 * 内壁
		 */
		...
		public static final int ALL[] = { GUNREST, REFIT, OUTSIDE_BODY,
				INTERNAL_CABINS, INNER_WALL, GUN_CARRIAGE, SPECIAL };
		public static final String ALL_STRING[] = { "炮座", "改装", "外身", "内舱",
				"内壁", "炮架", "特殊" };
