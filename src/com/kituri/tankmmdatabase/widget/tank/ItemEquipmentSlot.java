...
public class ItemEquipmentSlot extends RelativeLayout implements Populatable<Entry>, Selectable<Entry>, View.OnClickListener {
	...
	public ItemEquipmentSlot(Context context) {
		this(context, null);
	}

	public ItemEquipmentSlot(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ItemEquipmentSlot(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView() {
		...
		View convertView = LayoutInflater.from(this.getContext()).
				inflate(R.layout.item_equipment_slot, null);
