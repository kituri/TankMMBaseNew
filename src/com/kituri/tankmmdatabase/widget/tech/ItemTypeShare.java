...
public class ItemTypeShare extends RelativeLayout implements Populatable<Entry>, Selectable<Entry>, View.OnClickListener {
	...
	public ItemTypeShare(Context context) {
		this(context, null);
	}

	public ItemTypeShare(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ItemTypeShare(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initView() {
		...
		View convertView = LayoutInflater.from(this.getContext()).
				inflate(R.layout.item_tech_share, null);
