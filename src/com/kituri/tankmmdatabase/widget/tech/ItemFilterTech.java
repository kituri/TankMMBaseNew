...
public class ItemFilterTech extends RelativeLayout implements Populatable<Entry>, Selectable<Entry>, View.OnClickListener {
	...
	public ItemFilterTech(Context context, AttributeSet attrs, int defStyle) {
